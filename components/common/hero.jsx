...
export function Hero() {
    return (
        <section id={'home'} className=" h-[40rem] w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden top-0 right-0 pt-4">
            <Spotlight />
            ...
            <div className={'flex flex-col md:flex-row justify-center items-center lg:px-[15%] md:gap-8 content-center px-16 gap-0'}>
                ...
                <div className={'flex flex-col justify-center'}>
                    <div className={'flex flex-row order-last md:order-first pt-5 md:pt-0 justify-center md:justify-start gap-4'}>
                        ...
                        >
                            <FileDown className="invert-0 dark:invert transition-all duration-300" width={24} height={24} />
                        </Link>
                    </div>
