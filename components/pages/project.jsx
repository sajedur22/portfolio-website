...
export function Project() {
  const cards = projects.map((card, index) => <Card key={card.src} card={card} index={index} />);
        ...
        <React.Fragment key={i}>
          ...
          <div className="bg-[#E8F0FE] dark:bg-neutral-900 p-8 md:p-14 rounded-3xl mb-8">
            <p className="text-neutral-700 dark:text-neutral-300 text-base md:text-2xl font-sans max-w-3xl mx-auto mb-4">
              <span className="font-bold text-neutral-800 dark:text-neutral-100">Case Study</span>
            </p>
            <div>
              ...
              <ol>
                ...
                <li>
                  <span className={"text-white font-bold"}>WhatIBuilt:</span>
                  {item.whatIBuilt}
                </li>
                <li>
