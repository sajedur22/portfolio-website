    ...
    <section id={"about"} className={"bg-secondary-foreground w-full py-27"}>
      <div>
        <div className={"text-center max-w-3xl mx-auto"}>
          ...
          >
            Hi, I'm Shakil - a passionate Full Stack Developer with a knack for creating dynamic,
            user-friendly applications. Here's a look at the technologies I work with.
          </motion.p>
        </div>
